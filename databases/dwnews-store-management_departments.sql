...
CREATE TABLE `departments` (
  ...
  `department_name` varchar(32) COLLATE utf8_bin NOT NULL,
  `department_parent_id` int(11) NOT NULL DEFAULT '0',
  `department_leader_name` varchar(32) COLLATE utf8_bin DEFAULT NULL,
  `department_create_time` datetime DEFAULT CURRENT_TIMESTAMP,
